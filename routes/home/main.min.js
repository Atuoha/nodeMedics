'use strict';const express=require("express"),app=express(),router=express.Router(),User=require("../../models/User"),bcrypt=require("bcryptjs"),passport=require("passport"),LocalStrategy=require("passport-local").Strategy,Contact=require("../../models/Contact"),Department=require("../../models/Department"),Doctor=require("../../models/Doctor"),Appointment=require("../../models/Appointment");router.all("/*",(a,c,b)=>{a.app.locals.layout="home";b()});
router.get("/",(a,c)=>{Department.find().then(b=>{Doctor.find().then(d=>{c.render("home",{depts:b,docs:d})}).catch(d=>console.log(d))}).catch(b=>console.log(b))});router.get("/login",(a,c)=>{a.user?c.redirect("/admin"):c.render("home/login")});router.get("/register",(a,c)=>{a.user?c.redirect("/admin"):c.render("home/register")});
