...
router.get("/",(a,e)=>{const b=[User.countDocuments().exec(),Appointment.countDocuments().exec(),Doctor.countDocuments().exec(),Department.countDocuments().exec(),Research.countDocuments().exec(),Testimony.countDocuments().exec(),Service.countDocuments().exec(),Faq.countDocuments().exec(),Contact.countDocuments().exec(),Media.countDocuments().exec()];User.findOne({_id:a.user.id}).then(f=>{Department.find().then(c=>{Doctor.find().then(d=>{Promise.all(b).then(([g,h,k,l,m,n,p,q,r,t])=>{e.render("admin/index",
