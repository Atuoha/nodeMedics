...
router.post("/multiaction",(b,d)=>{console.log(b.body.checkboxes);Research.find({_id:b.body.checkboxes}).then(a=>{a.forEach(c=>{"img_place.png"!==c.file&&fs.unlink("./public/uploads/"+c.file,e=>{e&&console.log(e)});c.delete().then(e=>{b.flash("success_msg","Researches Deleted successfully :)");d.redirect("/admin/department")}).catch(e=>console.log(`Can't delete due to ${e}`))})}).catch(a=>console.log(a))});module.exports=router;